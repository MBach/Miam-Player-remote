...
package org.miamplayer.miamplayerremote.backend.listener;
...
public interface PlayerConnectionListener {
    ...
    void onConnectionStatusChanged(MiamPlayerPlayerConnection.ConnectionStatus status);

    void onMiamPlayerMessageReceived(MiamPlayerMessage miamPlayerMessage);
}
