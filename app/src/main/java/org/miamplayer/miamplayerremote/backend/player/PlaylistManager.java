...
public class PlaylistManager {
    ...
    public LinkedList<MyPlaylist> getAllPlaylists() {
        LinkedList<MyPlaylist> playlists = new LinkedList<>();
        for (int i = 0; i < mPlaylists.size(); ++i) {
    ...
    public void requestPlaylistSongs(int id) {
        ...
        msg.obj = MiamPlayerMessageFactory.buildRequestPlaylistSongs(id);
        App.MiamPlayerConnection.mHandler.sendMessage(msg);
    }

    public void clearPlaylist(int id) {
        Message msg = Message.obtain();
        msg.obj = MiamPlayerMessageFactory.buildRemoveMultipleSongsFromPlaylist(id,
