...
package org.miamplayer.miamplayerremote.utils.bundle;
...
{
    public static final String BUNDLE_EXTRA_INT_TYPE = "org.miamplayer.miamplayerremote.extra.TYPE"; //$NON-NLS-1$

    public static final String BUNDLE_EXTRA_STRING_IP = "org.miamplayer.miamplayerremote.extra.IP"; //$NON-NLS-1$

    public static final String BUNDLE_EXTRA_INT_PORT = "org.miamplayer.miamplayerremote.extra.PORT"; //$NON-NLS-1$

    public static final String BUNDLE_EXTRA_INT_AUTH = "org.miamplayer.miamplayerremote.extra.AUTH"; //$NON-NLS-1$
    ...
    public static final String BUNDLE_EXTRA_INT_VERSION_CODE =
            "org.miamplayer.miamplayerremote.extra.INT_VERSION_CODE"; //$NON-NLS-1$
    ...
    public static boolean isBundleValid(final Bundle bundle)
    {
         ...
         */
        if (!bundle.containsKey(BUNDLE_EXTRA_INT_TYPE))
        {
            if (Constants.IS_LOGGABLE)
            {
                Log.e(Constants.LOG_TAG,
                      String.format("bundle must contain extra %s", BUNDLE_EXTRA_INT_TYPE)); //$NON-NLS-1$
            }
            return false;
        }
    ...
    public static Bundle generateBundle(final Context context, final int type, final String ip, final int port, final int authCode)
    {
        final Bundle result = new Bundle();
        result.putInt(BUNDLE_EXTRA_INT_VERSION_CODE, Constants.getVersionCode(context));
        result.putInt(BUNDLE_EXTRA_INT_TYPE, type);
        result.putString(BUNDLE_EXTRA_STRING_IP, ip);
        result.putInt(BUNDLE_EXTRA_INT_PORT, port);
        result.putInt(BUNDLE_EXTRA_INT_AUTH, authCode);
