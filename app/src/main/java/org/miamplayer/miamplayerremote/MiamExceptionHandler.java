...
public class MiamExceptionHandler implements UncaughtExceptionHandler {
    ...
    public MiamExceptionHandler(Context context) {
        mContext = context;
    ...
    /**
     * Builds the filename for the stacktrace file (/data/data/org.miamplayer....)
     *
